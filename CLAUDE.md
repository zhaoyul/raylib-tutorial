...
**YOU ARE IN: `raylib/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/raylib/` (rig root) or other directories
...
**Your mail address:** `raylib/polecats/rust`
**Your rig:** raylib
**Your Witness:** `raylib/witness`
...
| Ask Witness for help | `gt mail send raylib/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`raylib/witness`) when:
...
```bash
gt mail send raylib/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
