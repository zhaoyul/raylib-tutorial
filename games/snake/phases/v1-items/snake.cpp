...
void Snake::updateDirection() {
    // 读取输入，但不能直接反向
    if ((IsKeyPressed(KEY_UP) || IsKeyPressed(KEY_W)) && !isOpposite(direction, Direction::UP)) {
        nextDirection = Direction::UP;
    }
    if ((IsKeyPressed(KEY_DOWN) || IsKeyPressed(KEY_S)) && !isOpposite(direction, Direction::DOWN)) {
        nextDirection = Direction::DOWN;
    }
    if ((IsKeyPressed(KEY_LEFT) || IsKeyPressed(KEY_A)) && !isOpposite(direction, Direction::LEFT)) {
        nextDirection = Direction::LEFT;
    }
    if ((IsKeyPressed(KEY_RIGHT) || IsKeyPressed(KEY_D)) && !isOpposite(direction, Direction::RIGHT)) {
