...
private:
    ...
    // 游戏对象
    std::unique_ptr<Snake> snake;           // 玩家1的蛇
    std::unique_ptr<Snake> snake2;          // 玩家2的蛇（对战模式）
...
private:
    ...
    void updateSnakeMovement(Snake& snakeRef, int& playerScore, int& playerLives, int playerId);
